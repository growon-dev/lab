...
A curated collection of experimental projects, creative coding sketches, and open-source explorations. Each directory houses a standalone mini-project serving as a sandbox for testing new graphics techniques, custom shaders, and interactive concepts.
...
**Live Demo:** [lab.growon.kr/pool-can](https://lab.growon.kr/pool-can/)
...
Run `npm run build` for a production bundle. Any push to `main` rebuilds every project and publishes them to GitHub Pages.
